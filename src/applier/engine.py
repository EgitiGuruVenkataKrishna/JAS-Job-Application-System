        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                if ats_type in [AtsType.WORKDAY, AtsType.UNKNOWN]:
                    ...
                    await self.fallback.handle(job_data)
                    return ApplyResult(
                        success=False,
                        method="fallback",
                ...
                # Take screenshot
                screenshot_name = f"{company}_apply_{ats_type.name.lower()}.png"
                screenshot_path = str(self.settings.screenshots_dir / screenshot_name)
                ...
                if success:
                    ...
                    return ApplyResult(
                        ...
                        method=ats_type.name.lower(),
                        screenshot_path=screenshot_path,
                        error="Form filling/submission failed",
                    )
